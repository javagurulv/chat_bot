...
public class RegisterUserFirstNameHandler implements DomainCommandHandler<RegisterUserFirstNameCommand, DomainCommandResult> {
    ...
    @Override
    public Class<RegisterUserFirstNameCommand> getCommandType() {
        return RegisterUserFirstNameCommand.class;
    }

    private DomainCommandResult updateUserFirstNameAndBuildResult(User user, RegisterUserFirstNameCommand command) {
